...
Statistics here are assessed for each repository, and aggregated into four
categories. Scores are on relative scales only (0 to 1), with higher scores
better than lower scores. The categories are:
...
The following table details aggregate scores in the four groups for each
repository or "package". Scores are shown for the latest time period only.
Clicking on the "package" values will lead to the repository maintenance page
with further details of the selected package or repository.
