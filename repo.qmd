...
similar_pkgs = matched_names.map(i => {
    ...
    return htl.html`<li><a href="/repometrics-demo/repo.html?repo=${i}" onclick="localStorage.setItem('orgmetricsRepo', '${i}')">${i}</a></li>`
});
```
...
<li>
<a href='/repometrics-demo/repo.html?repo=${d}' onclick="localStorage.setItem('orgmetricsRepo', '${d}')">${d}</a>
</li>`);
